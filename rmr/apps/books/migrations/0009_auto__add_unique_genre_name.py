...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Genre', fields ['name']
        db.create_unique('books_genre', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Genre', fields ['name']
        db.delete_unique('books_genre', ['name'])
